...
layout: default
---
Professional experience | [Portfolio](./projects.html) | [Blog articles](./blog-articles.html) | [Contact](mailto:cochenercamille@yahoo.fr)
...
* Implementing and training <span style="font-weight: bold; font-family: 'Yanone Kaffeesatz', sans-serif;">object detection</span> and <span style="font-weight: bold; font-family: 'Yanone Kaffeesatz', sans-serif;">semantic segmentation</span> models from notebooks to deployment
* Miniaturizing and testing neural networks on an embedded system
* Participating in bringing the models into production on the client's site
...
* Preparing and exploring the data, searching for <span style="font-weight: bold; font-family: 'Yanone Kaffeesatz', sans-serif;">correlations</span>
